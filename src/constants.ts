...
const optionPath = path.join(WEBINIZER_DIST_HOME, "project_caches", "config_fields", "options");
const configPath = path.join(WEBINIZER_DIST_HOME, "project_caches", "config_fields", "configs");
